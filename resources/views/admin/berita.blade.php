        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Inpu Data Berita</h5>
                            ...
                            <form action="/admin/berita/store" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="judulberita" id="judulberita"
                                            placeholder="Title">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="imageberita" class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-10">
