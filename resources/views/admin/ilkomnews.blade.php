...
@section('konten')
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/e-majalah">
                    <i class="bi bi-menu-button-wide"></i><span>E-Magazine</span><i></i>
                </a>
            </li><!-- End Components Nav -->

            <li class="nav-item">
                <a class="nav-link" data-bs-target="#forms-nav" href="/admin/berita">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Input Data Ilkom News</h5>

                            <!-- Horizontal Form -->
                            <form action="/admin/ilkomnews/store" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <label for="judulilkomnews" class="col-sm-2 col-form-label">Judul Ilkom News</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="judulilkomnews" id="judulilkomnews" placeholder="Title" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="imageilkomnews" class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" name="imageilkomnews" id="imageilkomnews">
                                    </div>
                                </div>

                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Isi Ilkom News</h5>
                                        <p>Masukkan Isi Ilkom News</p>
                                        <div id="quill_editor"></div>
                                        <input type="hidden" id="isiilkomnews" name="isiilkomnews">
                                    </div>
                                </div>
    ...
    <script>
        ...
        quill.on('text-change', function(delta, oldDelta, source) {
            document.getElementById("isiilkomnews").value = quill.root.innerHTML;
        });
    </script>
