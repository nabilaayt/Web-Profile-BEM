...
@section('konten')
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Inpu Data Birokrasi</h5>

                            <!-- Horizontal Form -->
                            <form action="/admin/birokrasi/store" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Judul Birokrasi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="judul-birokrasi"
                                            id="judul-birokrasi" placeholder="Title">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Lokasi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="lokasi-birokrasi"
                                            id="lokasi-birokrasi" placeholder="Location">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="date-birokrasi"
                                            id="date-birokrasi">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" name="image-birokrasi"
                                            id="image-birokrasi">
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Isi Birokrasi</h5>

                                        <!-- Quill Editor Full -->
                                        <p>Masukkan Isi Birokrasi</p>
                                        <div id="quill_editor"></div>
                                        <input type="hidden" id="isibirokrasi" name="isibirokrasi">
    ...
    <script>
        ...
        quill.on('text-change', function(delta, oldDelta, source) {
            document.getElementById("isibirokrasi").value = quill.root.innerHTML;
        });
    </script>
